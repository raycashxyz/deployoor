...
- 5ef32ea: End each written `deployments/**.json` and `deployments/sources/*.json` with a newline. The files
...
- 8e761ba: `deployoor verify --json` and `deployoor generate --json`, for scripts and agents that should not have to parse a summary
